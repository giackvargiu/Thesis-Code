...
# -*- coding: utf-8 -*-
"""
Created on Fri Jul 18 14:03:07 2025
...
deltaT_days4 = np.linspace(DeltaT_min4, DeltaT_Max4, n)

# Initialize  3D Delta-V matrix
Delta_V_matrix = np.zeros((n, n, n, n, n))
...
for i in range(n):
    ...
    for j in range(n):
        ...
        for k in range(n):
            ...
            r_planet = radius_planets[Planet_2]  
            r_soi_planet = soi_planets[Planet_2] 
            ...
            for l in range(n):
                ...
                r_planet_2 = radius_planets[Planet_3] 
                r_soi_planet_2 = soi_planets[Planet_3] 
                ...
                for m in range(n):
                    launch_date4 = arrival_date3
                    delta_t_days4 = deltaT_days4[m]
                    delta_t_centuries4 = delta_t_days4 / 36500
                    delta_t_seconds4 = delta_t_days4 * 86400
                    arrival_date4 = arrival_date3 + delta_t_centuries4

                    R5, V_planet_5, theta_5 = state_vector(Planet_5, arrival_date4)

                    # Lambert for P2 → P3
                    h_transfer4, intersection_SOI_dep4, intersection_SOI_arr4, V7, V8, r_arr4, r_dep4, x_dep4, y_dep4, z_dep4, x_arr4, y_arr4, z_arr4, x_transfer_rot4, y_transfer_rot4, z_transfer_rot4 = Lambert_3D(launch_date4, arrival_date4, Planet_4, Planet_5, delta_t_seconds4)
                    
                    
                    # Gravity assist
                    v_in_3 = V6 - V_planet_4
                    v_out_3 = V7 - V_planet_4
                    V3_in = np.linalg.norm(v_in_3)*1e-3
                    V3_out = np.linalg.norm(v_out_3)*1e-3
                    theta_3, deg_3 = turning_angle(v_in_3, v_out_3)

                    # Constants
                    mu_planet_3 = mu_planets[Planet_4]
                    r_planet_3 = radius_planets[Planet_4]  
                    r_soi_planet_3 = soi_planets[Planet_4] 

                    r_periapsis3, Delta_V4, r_SOI3, a1_3, a2_3 = compute_swingby_parameters(V3_in, V3_out, mu_planet_3, theta_3, r_planet_3, r_soi_planet_3)
            
            
            
                    # Compute Delta V Matrix
                    Delta_V1_vec = V1 - V_planet_1
                    Delta_V1 = np.linalg.norm(Delta_V1_vec)*1e-3
                
                    Delta_V5_vec = V_planet_5 - V8
                    Delta_V5 = np.linalg.norm(Delta_V5_vec)*1e-3
            
                    Delta_V = Delta_V1 + Delta_V2 + Delta_V3 + Delta_V4 +Delta_V5
                    #print(Delta_V)
                    
                    # Store results
                    Delta_V_matrix[i, j, k, l, m] = Delta_V


# Save to pickle
with open("Ve_Ea_Ma_Ju_Sa_5D_PCP_n150.pkl", "wb") as f:
